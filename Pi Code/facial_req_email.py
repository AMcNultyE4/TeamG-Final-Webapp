...
def send_message(name):
    return requests.post(
        "https://api.mailgun.net/v3/pisecure.net/messages",
        auth=("api", "2b829a0718f7d342d1bc506109757772-48c092ba-10551f20"),
        files = [("attachment", ("image.jpg", open("image.jpg", "rb").read()))],
        data={"from": 'alerts@pisecure.net',
            "to": ["pi_secure@outlook.com"],
